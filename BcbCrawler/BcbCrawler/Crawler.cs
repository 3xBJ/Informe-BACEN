...
namespace BcbCrawler
{
    ...
    {
        const string leiauteDRM = "https://www.bcb.gov.br/fis/pstaw10/leiauteDRM.asp?frame=1";
        const string leiauteDDR = "https://www.bcb.gov.br/fis/pstaw10/leiauteDDR.asp?frame=1";
        const string leiauteDLO = "https://www.bcb.gov.br/fis/pstaw10/leiaute_limitesdlo.asp?frame=1";

        const string xPath = "//body[1]/div[1]/table[{0}]/tbody[1]/tr";
